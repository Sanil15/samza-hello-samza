...
import samza.examples.wikipedia.task.WikipediaFeedConsumer;
 ...
 *
 */
public class WikipediaFeedConsumerTaskApplication implements TaskApplication {
  ...
  public void describe(TaskApplicationDescriptor taskApplicationDescriptor) {
    ...
    KafkaInputDescriptor inputDescriptor =
        kafkaSystemDescriptor.getInputDescriptor("wikipedia-raw-multi", new JsonSerde<>()).isBounded();
    ...
    taskApplicationDescriptor.withTaskFactory((StreamTaskFactory) () -> new WikipediaFeedConsumer());
  }
}
